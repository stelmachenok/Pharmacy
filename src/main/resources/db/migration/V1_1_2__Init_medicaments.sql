...
INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES
  ('5-НОК', 'Нитроксолин', 50.0, 'TABLET', 'Нитроксолин', 'WITHOUT_RECIPE', 1, UUID());

INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES
  ('АВАМИС', 'Флутиказон', 27.5, 'TABLET', 'Флутиказон', 'WITHOUT_RECIPE', 1, UUID());
INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES ('АВЕЛОКС', 'Моксифлоксацин', 400.0, 'TABLET', 'Моксифлоксацин', 'WITHOUT_RECIPE', 1,
        UUID());
INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES
  ('АВОДАРТ', 'Дутастерид', 0.5, 'CAPSULE', 'Дутастерид', 'WITHOUT_RECIPE', 2, UUID());
INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES ('АДАПТОЛ', 'Мебикар', 500.0, 'TABLET', 'Мебикар', 'WITHOUT_RECIPE', 1, UUID());
INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES ('АЕВИТ', 'Ретинол', 1.19, 'CAPSULE', 'Ретинол', 'WITHOUT_RECIPE', 1, UUID());
INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES
...
INSERT INTO Medicament (brandName, activeIngredient, dosage, packingForm, internationalNonproprietaryName, releaseForm, medicamentCategory, guid)
VALUES ('АДИЦЕФ', 'Цефдинир', 125.0, 'POWDER', 'Цефдинир', 'WITHOUT_RECIPE', 1, UUID());
