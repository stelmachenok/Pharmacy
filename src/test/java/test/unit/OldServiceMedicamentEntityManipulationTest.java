...
//    @BeforeEach
//    void serviceInit(){
//        service = new MedicamentServiceImpl(new MedicamentDAO(), new MedicineConverter(new CategoryConverter()));
//    }
//
//    @Test
...
//        service.add(new MedicamentDto("L-ОПТИК", "Левофлоксацин", 5.0, PackingForm.DROP, "Левофлоксацин", ReleaseForm.WITHOUT_RECIPE, categoryDto));
//    }
//
//    @Test
//    void addTwoDiffMedicament() throws EntityAlreadyExistException, ObjectValidationFailedException {
//        CategoryDto categoryDto = new CategoryDto("Категория A", "Описание 1");
//        service.add(new MedicamentDto("L-ТИРОКСИН", "Левотироксин натрия", 50.0, PackingForm.TABLET, "Левотироксин натрия", ReleaseForm.WITHOUT_RECIPE, categoryDto));
//        service.add(new MedicamentDto("L-ОПТИК", "Левофлоксацин", 5.0, PackingForm.DROP, "Левофлоксацин", ReleaseForm.WITHOUT_RECIPE, categoryDto));
//    }
//
//    @Test
...
//        CategoryDto categoryDto = new CategoryDto("Категория A", "Описание 1");
//        MedicamentDto medicamentDto = new MedicamentDto("L-ТИРОКСИН", "Левотироксин натрия", 50.0, PackingForm.TABLET, "Левотироксин натрия", ReleaseForm.WITHOUT_RECIPE, categoryDto);
...
//        CategoryDto categoryDto = new CategoryDto("Категория A", "Описание 1");
//        MedicamentDto medicamentDto = new MedicamentDto("L-ТИРОКСИН", "Левотироксин натрия", 50.0, PackingForm.TABLET, "Левотироксин натрия", ReleaseForm.WITHOUT_RECIPE, categoryDto);
//        MedicamentDto medicamentDto2 = new MedicamentDto("АВАМИС", "Флутиказон", 27.5, PackingForm.AEROSOL, "Флутиказон", ReleaseForm.WITHOUT_RECIPE, categoryDto);
//        service.add(medicamentDto);
